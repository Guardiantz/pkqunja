                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-12 d-flex justify-content-center">
                                <img src="../img/<?= $pecah['foto_PasFoto']; ?>" alt="" class="rounded-circle w-50" style="box-shadow: 0px 6px 2px rgba(0, 0, 0, 0.25);"><br>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12 d-flex justify-content-center">
                                <p class=" fw-medium text-light py-2"><?= $pecah['nama']; ?></p>
                            </div>
                        </div>
                    </div>
