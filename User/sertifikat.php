...
<body>
    ...
    <div class="container-fluid">
        <div class="p-2 m-5">
            ...
            <span class="fs-3"><b>Sertifikat PKQ UNJA</b></span>
                ...
                <div class="offcanvas-body p-0">
                    <div class="container">
                        <div class="list_menu row">
                            <a href="pendaftaran.php" class="py-2 col-sm-10 offset-sm-2">
                        ...
                        <div class="list_menu row">
                            <a href="ngaji.php" class="py-2 col-sm-10 offset-sm-2">
                        ...
                        <div class="list_menu row">
                            <a href="sertifikat.php" class="py-2 col-sm-10 offset-sm-2">
                        ...
                        <div class="list_menu row">
                            <a href="../logout.php" class="py-2 col-sm-10 offset-sm-2">
            ...
            <div class="container w-75 ms-5 border border-black border-1 mt-3 px-5 rounded shadow-lg">
                <form action="" enctype="file">
                    <div class="row my-4">
                        <button type="submit" class="btn btn-success col-sm-3 offset-sm-9 shadow">
                            Ajukan Sertifikat
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="ms-2 bi bi-send-fill" viewBox="0 0 16 16">
                    ...
                    <div class="row mb-4">
                        ...
                        <input type=" text" name="nama" placeholder="Input Your Name" class="col-5" aria-label="nama" autocomplete="off" required value="<?= $pecah['nama']; ?>">
                            <p class="col-sm-8 my-0 offset-sm-4" style="font-size: 12px;">Pastikan nama Anda sesuai dengan KTM Anda. Ini akan digunakan dalam cetak sertifikat</p>

                    </div>

                    <div class="row mb-4">
                        <label for="nim" class="col-2 offset-sm-2">NIM*</label>
                        <input type="text" name="nim" placeholder="Input Your NIM" class="col-5" aria-label="nim" autocomplete="off" required value="<?= $pecah['nim']; ?>">
                        <p class="col-6 my-0 offset-sm-4" style="font-size: 12px;">Pastikan nama Anda <b>sesuai dengan KTM Anda</b></p>
                    </div>
            ...
            <div class="row my-5">
                <button type="submit" class="btn btn-success col-sm-2 offset-sm-4 shadow">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="me-2 bi bi-box-arrow-down" viewBox="0 0 16 16">
