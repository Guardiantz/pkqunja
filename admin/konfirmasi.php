...
<body>
    <div class="container-fluid">
        <div class="p-2 m-5">
            ...
            <span class="fs-3"><b>Konfirmasi</b></span>
            ...
            <div class="w-100 mt-3 rounded py-4 px-3 shadow-lg" style="height: 80vh;">
                <table class="table mx-5" cellpadding="5">
                    <thead style="color: #E09326;">
                        <tr>
                            <th class="text-center border">No Req</th>
                            ...
                            <tr>
                                ...
                                <td class="px-0 border-0">
                                    <form action="" method="post">
                                        <button type="submit" class="btn shadow mx-0" name="setuju" id="setuju" style="background: #099699; color: white;">
