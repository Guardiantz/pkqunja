        ...
        <div class="p-2 m-5">
            ...
            <div class="row mt-2">
                <form action="" method="post" class="col-sm-3">
                    <p class="d-inline fw-bold">Tanggal</p>
                    <input type="text" class="border rounded w-75" id="floatingInput" autocomplete="off">
                </form>
                <form action="" method="post" class="col-sm-3 offset-sm-6">
                ...
                <table class="table" cellpadding="5">
                    <thead style="color: #E09326;">
                        <tr>
                            ...
                            <th class="text-center border">Mahasiswa</th>
                            <th class="text-center border">Batas Ngaji</th>
                            <th class="text-center border">Waktu</th>
                        </tr>
                    </thead>
                    <tbody class=" text-center">
                        ...
                        <?php foreach ($result as $isi) { ?>
                            <tr>
                                ...
                                <td class="border"><?= date("H.i"), " WIB" ?></td>
                            </tr>
                            <?php $i++; ?>
                        <?php } ?>
                    </tbody>
