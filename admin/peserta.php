...
if (!isset($_SESSION['login2']) || $_SESSION['login2'] !== true) {
...
<body>
    <div class="container-fluid">
        <div class="p-2 m-5">
            ...
            <span class="fs-3"><b>Data Peserta</b></span>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-12 d-flex justify-content-center">
                                <img src="../img/profile_kosong.jpeg" alt="" class="rounded-circle w-50" style="box-shadow: 0px 6px 2px rgba(0, 0, 0, 0.25);"><br>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12 d-flex justify-content-center">
                                <p class=" fw-medium text-light py-2">Admin</p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="offcanvas-body p-0">
                    <div class="container">
                        <div class="list_menu row">
                            <a href="peserta.php" class="py-2 col-sm-10 offset-sm-2">
                        ...
                        <div class="list_menu row">
                            <a href="konfirmasi.php" class="py-2 col-sm-10 offset-sm-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="50" fill="currentColor" class="bi bi-card-checklist px-3" viewBox="0 0 16 16" style="color: #E09326;">
            ...
            <div class="row">
                <form action="" method="post" class="col-sm-3 offset-sm-9">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-search" viewBox="0 0 16 16">
                        <path d="M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001c.03.04.062.078.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1.007 1.007 0 0 0-.115-.1zM12 6.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0z" />
                    </svg>
                    <input type="text" class="border rounded w-75" id="floatingInput" placeholder=" Search " autocomplete="off" name="keyword">
                    <button type="submit" class="d-inline" name="cari">Cari</button>
                </form>
            </div>

            <div class="w-100 mt-3 rounded py-4 px-3 shadow-lg" style="height: 80vh;">
                <table class="table" cellpadding="5">
                    <thead style="color: #E09326;">
                        <tr>
                            <th class="text-center border align-middle">No Req</th>
                            <th class="text-center border align-middle">Nama</th>
                            <th class="text-center border">NIM</th>
                            <th class="text-center border">Fakultas</th>
                            <th class="text-center border">Prodi</th>
                        </tr>
                    </thead>
                    <tbody class=" text-center">
                        ...
                        <?php foreach ($result as $isi) { ?>
                            <tr>
                                <td class="border"><?= $isi['no_req']; ?></td>
                                <td class="border"><?= $isi['nama']; ?></td>
                                <td class="border"><?= $isi['nim']; ?></td>
                                <td class="border"><?= $isi['fakultas']; ?></td>
                                <td class="border"><?= $isi['prodi']; ?></td>
                            </tr>
                            <?php $i++; ?>
                        <?php } ?>
                    </tbody>
